...
class DeepseekConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        consecutive_expert_loss_weight=0.0,
        consecutive_expert_loss_type="kl",
        **kwargs,
    ):
        ...
        self.consecutive_expert_loss_weight = consecutive_expert_loss_weight
        self.consecutive_expert_loss_type = consecutive_expert_loss_type
